...
var DEV_REQUIRE = "var globalObj = (typeof self === 'object' ? self : global);\
  globalObj.devRequire = function(request) {\
  ...
  compile: function(bundleUrl) {
    if (!this._compiledSrc && !this.error) {
      try {
        ...
        var scriptsToLoad = _.uniq(_(this._modules).reduce(function(scriptsToLoad, module) {
          return scriptsToLoad.concat(module.scriptsToLoad());
        }, []));
        ...
        this._compiledSrc = template.compile('bundle', _.extend({}, this._options, {
          ...
          scriptsToLoad: JSON.stringify(scriptsToLoad, null, 2),
          appends: this._options.devRequire ? DEV_REQUIRE : ''
        }));
      } catch (e) {
        this.error = e;
      }
