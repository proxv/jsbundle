...
Bundle.prototype = {
  _load: function() {
    ...
    console.error('Loading bundle: ' + this._entryFile);

    this._modules = [];
    this._moduleFileToIdMap = {};
    this._moduleHashToIdMap = {};
    this._duplicateIdCount = {};
    ...
    while (files.length > 0) {
      ...
      if (!id) { // We haven't seen this file before.
        ...
        if (this._duplicateIdCount[id]) {
          this._duplicateIdCount[id]++;
        } else {
          this._duplicateIdCount[id] = 1;
        }
      ...
      fs.watchFile(filename, {
        ...
        fs.stat(filename, function(err) {
          ...
          if (oldHash !== newHash) {
            ...
            if (itself._duplicateIdCount[id] === 1) {
